...
function set_pg_content(pg_id) {
  ...
  switch (pg_id) {
           ...
           break;
           case 2:
           content ='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.png" width="1080" height="810"></div>';
           break;

           case 3:
           content ='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="background"><img src="slide3/1.png" width="1080" height="810"><div class="jump2" onclick=jump2()></div></div>';
           break;
           case 4:
           content='<link rel="stylesheet" type="text/css" href="slide4/slide4.css" media="screen"/> <div class="background"><img src="slide4/1.png" width="1080" height="810"/></div><div class="title2" class="frameopen" onclick="framepop()"><div class="popupImgclick"></div></div><div class="frame"><img src="slide4/3.png" width="1080"></div><div class="frameclose" onclick="frameclose()"><img src="close2.png"/></div>';
           break;
           case 5:
           content='<link rel="stylesheet" type="text/css" href="slide5/slide5.css" media="screen"/> <div class="background"><img src="slide5/bg.png" width="1080" height="810"/></div>  <div class="title1"><img src="slide5/1.png"/></div> <div class="title2"><img src="slide5/2.png"/></div> <div class="title3"><img src="slide5/3.png"/></div> <div class="title4"><img src="slide5/4.png"/></div> <div class="title5"><img src="slide5/5.png"/></div>';
           break;        
           case 6:
           content ='<link rel="stylesheet" type="text/css" href="slide6/slide6.css" media="screen"/><div class="background"><img src="slide6/1.png" width="1080" height="810"></div><div class="title2" class="frameopen" onclick="framepop()"></div><div class="frame"><img src="slide6/pop1.png" width="1080"></div><div class="frameclose" onclick="frameclose()"><img src="close2.png"/></div><div class="pop2" onclick="popup2()"></div><div class="pop2open"><img src="slide6/pop2.png" width="1080"><div class="graphpop"><img src="slide6/pop1a.png"/></div></div><div class="frameclose2" onclick="pop2close()"><img src="close2.png"/></div>';
           break;       
           case 7:
           content ='<link rel="stylesheet" type="text/css" href="slide7/slide7.css" media="screen"/><div class="background"><img src="slide7/1.png" width="1080" height="810"></div><div class="pop5" onclick="popup5()"></div><div class="pop5open"><img src="slide7/pop5.png" width="1080"></div><div class="frameclose5" onclick="pop5close()"><img src="close2.png"/></div>';
           break;
      }
